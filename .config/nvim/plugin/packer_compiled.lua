...
_G.packer_plugins = {
  ["aerial.nvim"] = {
    loaded = true,
    path = "/home/alikaleg/.local/share/nvim/site/pack/packer/start/aerial.nvim",
  ...
  ["kanagawa.nvim"] = {
    loaded = true,
    path = "/home/alikaleg/.local/share/nvim/site/pack/packer/start/kanagawa.nvim",
  ...
  ["oil.nvim"] = {
    ...
    loaded = true,
    path = "/home/alikaleg/.local/share/nvim/site/pack/packer/start/oil.nvim",
